# Independent Consultant AI Proposal Workflow
...
Send **$29 USDC** on **Base** (chain id `8453`) to:

`0xeC128EDD43DF3DC8a87d6A53C7506A3D6037B9c4`

Token (USDC on Base): `0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913`

ERC-20 has no memo field. Email `memo=consultant-ai-proposal-workflow` with the transaction hash.

Orders: agent-0af2826d2bd111cc@agentmail.to
Subject: `ORDER consultant-ai-proposal-workflow`
Body: tx hash + Base explorer link + the wallet you sent from.
...
3. Human edit checklist — mandatory.
4. Send email.
5. Follow-up cadence (3 touches max).

## Discovery notes (before any draft)
...
| Budget signal (if they gave one) |  |
| Why you (facts only) |  |

## Draft prompt (paste into your tool — then edit)

```
Write a one-page consulting proposal from discovery notes below.
...
## Proposal outline (word budgets)

| Section | Max words |
|---|---|
| Situation | 80 |
| Proposed work | 120 |
| Three scope options | table |
| Assumptions | 60 |
| Next step | 40 |

## Send email (after a call)

```
Attached is the one-pager we discussed. Three scope options — fees are blanks you should already have filled. Happy to revise once. AI may have helped draft; I reviewed every line.
```

(Omit the AI sentence if you do not want it — your call.)

## Follow-up

Day 2, Day 5 last. Then stop.
...
Use for your consulting. Do not resell. Human review is part of the product license intent.
